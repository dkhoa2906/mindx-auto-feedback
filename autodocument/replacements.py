...
def get_replacements(student_name, student_yob, subject, trial_date, trial_mentor, trial_place, points, feedback):
    replacements = {
        ...
        "{{subject}}": subject,
        "{{trial_city}}": "Bình Dương" if trial_place == "Dĩ An" else "TPHCM"
    }
    ...
    if subject in ["Game Creator - GB", "Scratch Creator - SB"]:
        ...
        replacements = get_replacements(student_name, student_yob, "Robotics - PRE",
                                        trial_date, trial_mentor, trial_place, points, feedback)
